...
//Dialogs
const { ReporteFallaServicioDialog } = require('./dialogs/reporteFallaServicioDialog');
const { RegistroPQRDialog } = require('./dialogs/registroPQRDialog');
...
const { BonitaIntegration } = require('./integrations/bonita')
...
proceso.usarBPMS(new BonitaIntegration(Configuration.bonita))

// Create the main dialog.
const reporteFallaDialog = new ReporteFallaServicioDialog(userState, proceso);
